...
namespace Appointment
{
    public class EmployeeData {
        ...
        public Dictionary<int,Treatment> employeeTreatment1()
        {
            Dictionary<int, Treatment> allTreatments = new Dictionary<int, Treatment>()
            {
                {1, new Treatment() { Id = 1, TreatmentName = "Fullset", TreatmentType = TreatmentType.Acrylic, Duration = 45, Price = 22 } },
               {2, new Treatment() { Id = 2, TreatmentName = "Infill", TreatmentType = TreatmentType.Acrylic, Duration = 45, Price = 16 } },
